...
export class DefaultApiApi extends RESTDataSource {
     ...
     * @param {'any' | 'lightning' | 'hive' | 'webmonetization'} [val] Only returns feeds with a &#x60;value&#x60; block of the specified type. Use &#x60;any&#x60; to return feeds with any &#x60;value&#x60; block. 
     ...
     * @throws {UserInputError}
     */
    searchByterm(q: string, val?: 'any' | 'lightning' | 'hive' | 'webmonetization', clean?: boolean, fulltext?: boolean, pretty?: boolean, ): Promise<InlineResponse200> {
        // verify required parameter 'q' is not null or undefined
        if (!q) {
